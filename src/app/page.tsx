...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-6">
      <p className="text-sm">
        Santarém-based Software Engineer with strong experience in Android and Kotlin, currently at Jeitto, building and optimizing mobile solutions for millions of users. Passionate about intuitive UI, technical refinement, and scalable architecture. Background in backend and full stack development, with a degree in Computer Engineering from UFPA. Always focused on delivering impactful, user-centered products.
      </p>
      ...
      <div className="flex justify-center gap-6 max-sm:flex-col-reverse sm:justify-between">
        <div className="flex flex-col justify-center gap-4 max-sm:items-center">
          <div className="group -m-8 flex select-all items-center gap-3 p-8 transition-all">
            ...
            <div className="inline-flex items-center gap-3">
              ...
              <a
                href="mailto:contato@iamageo.dev"
        ...
        <div className="flex flex-col gap-2">
          <a
            href="/geovani-amaral-cv.pdf"
            download="Geovani-Amaral-CV.pdf"
